...
<%
	...
	{
		Usuario usuActual;	
		mensaje += "<select required name='id_usu'  onchange='cargarUsu(this.value,3);'>"+
...
<div float="left" class="container-fluid">
	...
	<a href="reporteUsuariosAll.jsp"><input type="button" value="PDF"></button></a>
	<a href="reporteUsuariosAllExcel.jsp"><input type="button" value="EXCEL"></button></a>
</div>
