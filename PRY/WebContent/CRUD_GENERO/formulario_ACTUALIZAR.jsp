...
<body>
	<form class="" action="CRUD_GENERO/controlador_ACTUALIZAR.jsp" method="get" role="form">
		<div class="row">
			<div class="col-md-7">
				<fieldset>
			...
			<div class="col-md-7">
				<div class="row">
					<div class="col-md-7">
						<div class="form-group">
							<label for="nombres">Nuevo Nombre:</label> <input id="genero"
								class="form-control" type="text" name="nvo_genero">
						</div>
					</div>
				</div>
				<input type="hidden" name="id_usuario_creador"
					value="<%=session.getAttribute("id_usuario")%>"> <input
					class="btn btn-primary" type="submit" value="Actualizar Género">
			</div>
		</div>
	</form>
</body>
