...
<%
	...
	InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("CRUD_BOLETAPAGO/BoletaPago.jasper");
	try {
	...
	exportador.setParameter(JRExporterParameter.OUTPUT_FILE_NAME,"BoletaPago.xls");
	...
	FileInputStream entrada = new FileInputStream("BoletaPago.xls");
	byte[] lectura = new byte[entrada.available()];
	entrada.read(lectura);
	response.setContentType("application/vnd.ms-excel");
	response.setHeader("Content-Disposition","attachment; filename=BoletaPago.xls");
