...
<%
	...
	InputStream reportStream = getServletConfig().getServletContext().getResourceAsStream("CRUD_PUESTO/Puestos.jasper");
	try {
	...
	exportador.setParameter(JRExporterParameter.OUTPUT_FILE_NAME,"Puestos.xls");
	...
	FileInputStream entrada = new FileInputStream("Puestos.xls");
	byte[] lectura = new byte[entrada.available()];
	entrada.read(lectura);
	response.setContentType("application/vnd.ms-excel");
	response.setHeader("Content-Disposition","attachment; filename=Puestos.xls");
